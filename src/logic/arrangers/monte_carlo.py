...
from validator import Rule, DocumentParser, Validator
from typing import List, Dict

class MonteCarloArranger(BaseArranger):
    ...
    def _generate_random_position_for_object(self, obj):
        ...
        room_center = self._room.get_center()
    ...
    def _is_position_valid_for_object(self, obj, position):
        ...
        # checking collisions
        is_valid = True
        for other_obj in self._objects:
    ...
    def _get_objects_by_type(self, obj_type_str):
        ...
        if obj_type_str == "any":
            ...
            return [obj for obj in self._objects if obj.get_type() == "Cube"]
        elif obj_type_str == "sphere":
            return [obj for obj in self._objects if obj.get_type() == "Sphere"]
        else:
            return []
